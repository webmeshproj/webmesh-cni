module github.com/webmeshproj/webmesh-cni
...
require (
	...
	github.com/webmeshproj/storage-provider-k8s v0.0.3-0.20231005144941-d7635b7a42a7
	github.com/webmeshproj/webmesh v0.11.2-0.20231005183330-4a6812ddb4a9
